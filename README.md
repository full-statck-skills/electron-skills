...
[![GitHub](https://img.shields.io/badge/github-full--statck--skills%2Felectron-skills-green.svg)](https://github.com/full-statck-skills/electron-skills)
...
```bash
npx skills add full-statck-skills/electron-skills
```

Or install specific skills:

```bash
npx skills add full-statck-skills/electron-skills --skill <skill-name>
```
...
```bash
git clone https://github.com/full-statck-skills/electron-skills.git
